...
ROOT_DIR = os.path.abspath("/content/maskrcnn_colab/mrcnn_demo")

# Import Mask RCNN
sys.path.append(ROOT_DIR)  # To find local version of the library
from content.maskrcnn.config import Config
from content.maskrcnn import utils
import content.maskrcnn.model as modellib
from content.maskrcnn import visualize
from content.maskrcnn.model import log
...
COCO_MODEL_PATH = os.path.abspath("content/maskrcnn/mask_rcnn_coco.h5")
